...
class INFOKEY:
    ...
    gsetsize = "gsetsize"
    inaddgset = "inaddgset"
    inaddgsetsize = "inaddgsetsize"
    mgset = "mgset"
    mgsetsize = "mgsetsize"
    detectgset = "detectgset"
    detectgsetsize = "detectgsetsize"
    addgset = "addgset"
    addgsetsize = "addgsetsize"
    ox = "ox"
    oy = "oy"
    ow = "ow"
    oh = "oh"
    ...
    inaddalsoActivate = "inaddalsoActivate"
    inaddid = "inaddid"
    inaddglobalMessage = "inaddglobalMessage"
    inaddglobalMessage_delayPerChar = "inaddglobalMessage_delayPerChar"
    inaddglobalMessage_textColor = "inaddglobalMessage_textColor"
    inadddebugMessage = "inadddebugMessage"
    inaddallToActivate = "inaddallToActivate"
    inaddshowOnMap = "inaddshowOnMap"

    malsoActivate = "malsoActivate"
    mid = "mid"
    mglobalMessage = "mglobalMessage"
    mglobalMessage_delayPerChar = "mglobalMessage_delayPerChar"
    mglobalMessage_textColor = "mglobalMessage_textColor"
    mdebugMessage = "mdebugMessage"
    mallToActivate = "mallToActivate"
    mshowOnMap = "mshowOnMap"

    addalsoActivate = "addalsoActivate"
    addid = "addid"
    addglobalMessage = "addglobalMessage"
    addglobalMessage_delayPerChar = "addglobalMessage_delayPerChar"
    addglobalMessage_textColor = "addglobalMessage_textColor"
    adddebugMessage = "adddebugMessage"
    addallToActivate = "addallToActivate"
    addshowOnMap = "addshowOnMap"

    detectalsoActivate = "detectalsoActivate"
    detectid = "detectid"
    detectglobalMessage = "detectglobalMessage"
    detectglobalMessage_delayPerChar = "detectglobalMessage_delayPerChar"
    detectglobalMessage_textColor = "detectglobalMessage_textColor"
    detectdebugMessage = "detectdebugMessage"
    detectallToActivate = "detectallToActivate"
    detectshowOnMap = "detectshowOnMap"
